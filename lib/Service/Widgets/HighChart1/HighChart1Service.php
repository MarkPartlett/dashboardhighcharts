...
namespace OCA\DashboardHighCharts\Service\Widgets\HighChart1;
...
class HighChart1Service {
	...
	public function getHighChart1Data() {
	
	$widgetId ='HighChart1';
	$userId = $this->userId;

	$HighChart1Data = $this->dataRequest->get($widgetId, $userId );
	return ($HighChart1Data);
	}
