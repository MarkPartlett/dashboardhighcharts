...
namespace OCA\DashboardHighCharts\Service\Widgets\HighChart3;
...
class HighChart3Service {
	...
	public function getHighChart3Data() {
	
	$widgetId ='HighChart3';
	$userId = $this->userId;

	$HighChart3Data = $this->dataRequest->get($widgetId, $userId );
	return ($HighChart3Data);
	}
