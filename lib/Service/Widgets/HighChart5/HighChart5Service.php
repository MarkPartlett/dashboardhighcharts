...
namespace OCA\DashboardHighCharts\Service\Widgets\HighChart5;
...
class HighChart5Service {
	...
	public function getHighChart5Data() {
	
	$widgetId ='HighChart5';
	$userId = $this->userId;

	$HighChart5Data = $this->dataRequest->get($widgetId, $userId );
	return ($HighChart5Data);
	}
